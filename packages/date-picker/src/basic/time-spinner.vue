...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'zttxsjz-element-ui/src/utils/date-util';
  import ElScrollbar from 'zttxsjz-element-ui/packages/scrollbar';
  import RepeatClick from 'zttxsjz-element-ui/src/directives/repeat-click';
